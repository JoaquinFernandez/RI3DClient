...
public class VncViewer extends Container
implements java.lang.Runnable, WindowListener {
	...
	public boolean xvpExtensions;
	// Should we show XVP control buttons
	public boolean xvpShutdown;
	public boolean xvpReboot;
	public boolean xvpReset;
	...
	fatalError("Unable to decode vm string: " + vm, e);
		...
		if (url.getProtocol().equals("http")) {
			socketFactory = "com.gamanne.ri3d.client.vncwiewer.HTTPConnectSocketFactory";
		}
		else if (url.getProtocol().equals("https")) {
			socketFactory = "com.gamanne.ri3d.client.vncwiewer.HTTPSConnectSocketFactory";
		}
		else {
	...
	void showMessage(String msg) {
		...
		if (offerRelogin) {
			...
			Panel outerPanel = new Panel(new FlowLayout(FlowLayout.CENTER));
			outerPanel.add(gridPanel);
			vncContainer.setLayout(new FlowLayout(FlowLayout.CENTER, 30, 16));
			...
			vncContainer.setLayout(new FlowLayout(FlowLayout.CENTER, 30, 30));
