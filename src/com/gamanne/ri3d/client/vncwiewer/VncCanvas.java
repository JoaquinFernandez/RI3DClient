...
public class VncCanvas extends Canvas
  ...
  public int statNumUpdates;           // counter for FramebufferUpdate messages
  public int statNumTotalRects;        // rectangles in FramebufferUpdate messages
  public int statNumPixelRects;        // the same, but excluding pseudo-rectangles
  public int statNumRectsTight;        // Tight-encoded rectangles (including JPEG)
  public int statNumRectsTightJPEG;    // JPEG-compressed Tight-encoded rectangles
  public int statNumRectsZRLE;         // ZRLE-encoded rectangles
  public int statNumRectsHextile;      // Hextile-encoded rectangles
  public int statNumRectsRaw;          // Raw-encoded rectangles
  public int statNumRectsCopy;         // CopyRect rectangles
  public int statNumBytesEncoded;      // number of bytes in updates, as received
  public int statNumBytesDecoded;      // number of bytes, as if Raw encoding was used
